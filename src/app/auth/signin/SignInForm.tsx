    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl border border-gray-400 dark:border-gray-700 shadow p-8">
        ...
        <form action={signIn} className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <a href="/auth/forgot-password" className="text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
                Forgot password?
              </a>
            </div>
            <input
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          No account yet?{' '}
          <a href="/auth/signup" className="font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
            Sign up
          </a>
        </p>
      </div>
